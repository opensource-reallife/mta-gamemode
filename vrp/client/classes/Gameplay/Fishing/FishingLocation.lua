...
FishingLocation.Map = {
	...
	-- The cave col must be above river cols cause it is in one of them!
	{location = "cave", func = createColCuboid, waterHeight = 12.8, args = {Vector3(-427, 1335, 12), 20, 50, 5}},
	...
	{location = "swamp", func = createColCircle, waterHeight = 5, args = {Vector2(-749, -1959), 120}},
