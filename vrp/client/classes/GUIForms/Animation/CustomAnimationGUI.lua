...
function CustomAnimationGUI:constructor()
	...
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"Spezialanimationen", true, true, self)
    ...
    self.m_CustomAnimationList:addItem(_"Zurück").onLeftDoubleClick = function () self.m_Window:close() AnimationGUI:new() end
