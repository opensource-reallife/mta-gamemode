...
function StateFactionNoteGUI:constructor(target)
	...
	GUILabel:new(30, 45, self.m_Width-60, 30, _("Spieler: %s", target:getName()), self):setColor(Color.Accent)
	...
	self.m_Set:setBackgroundColor(Color.Accent):setFont(VRPFont(28)):setFontSize(1)
