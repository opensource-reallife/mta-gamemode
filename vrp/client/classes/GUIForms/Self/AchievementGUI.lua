...
function AchievementGUI:constructor(money)
	...
	GUILabel:new(self.m_Width*0.45, self.m_Height*0.15, self.m_Width*0.55, self.m_Height*0.05, _("Auf %s gibt es viele Achievements mit verschiedenen Belohnungen, die gefunden bzw. erledigt werden können. Einige davon sind vesteckt und tauchen erst in der Liste auf wenn du diese findest!", PROJECT_NAME), self.m_Window):setMultiline(true)
