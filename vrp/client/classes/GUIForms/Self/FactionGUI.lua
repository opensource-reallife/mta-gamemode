...
function FactionGUI:Event_gangwarLoadArea(name, position, owner, lastAttack, isAttackable, active)
	self.m_GangwarAreas[name] = {["name"] = name, ["posX"] = position[1], ["posY"] = position[2], ["posZ"] = posZ, ["owner"] = owner, ["lastAttack"] = lastAttack, ["active"] = active}
