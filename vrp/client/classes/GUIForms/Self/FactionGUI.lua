...
function FactionGUI:constructor()
	...
	self.m_FactionRespawnVehicleButton = GUIButton:new(self.m_Width*0.02, self.m_Height*0.6, self.m_Width*0.3, self.m_Height*0.07, _"Fahrzeuge respawnen", tabAllgemein):setBarEnabled(true):setTooltip("Linksklick für angekündigten Respawn \nRechtsklick für sofortigen Respawn", "button", true)
	self.m_FactionRespawnVehicleButton.onLeftClick = bind(self.FactionRespawnVehicles, self, false) -- announced
	self.m_FactionRespawnVehicleButton.onRightClick = bind(self.FactionRespawnVehicles, self, true) -- instant
	...
	self.m_FactoryButton = GUIButton:new(self.m_Width*0.7, self.m_Height*0.6, self.m_Width*0.3, self.m_Height*0.07, _"Fabriken", tabAllgemein):setBarEnabled(true)
	...
	self.m_FactionPlayersGrid:addColumn("", 0.06)
	self.m_FactionPlayersGrid:addColumn("", 0.06)
...
function FactionGUI:onGangwarItemSelect(item)
	...
	elseif item == self.m_GangAttackBestLog then
		...
		self.m_GangAttackDamageTab = self.m_GangAttackTab:addTab(_("Schaden"))
			...
			self.m_GangAttackDamageGrid:addColumn("", 0.1)
		...
		self.m_GangAttackKillTab = self.m_GangAttackTab:addTab(_("Tötungen"))
			...
			self.m_GangAttackKillGrid:addColumn("", 0.1)
		...
		self.m_GangAttackMVPTab = self.m_GangAttackTab:addTab(_("MVP"))
			...
			self.m_GangAttackMVPGrid:addColumn("", 0.1)
