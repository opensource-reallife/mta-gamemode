...
function FurnitureShopGUI.initialize()
	...
	for i = 1, 18 do
		removeWorldModel(2832, 10000, 0, 0, 0, i)
		removeWorldModel(2850, 10000, 0, 0, 0, i)
		removeWorldModel(2812, 10000, 0, 0, 0, i)
		removeWorldModel(2829, 10000, 0, 0, 0, i)
		removeWorldModel(2830, 10000, 0, 0, 0, i)
		removeWorldModel(2831, 10000, 0, 0, 0, i)
		removeWorldModel(2816, 10000, 0, 0, 0, i)
		removeWorldModel(2826, 10000, 0, 0, 0, i)
		removeWorldModel(2852, 10000, 0, 0, 0, i)
		removeWorldModel(2857, 10000, 0, 0, 0, i)
		removeWorldModel(2858, 10000, 0, 0, 0, i)
		removeWorldModel(2859, 10000, 0, 0, 0, i)
		removeWorldModel(2860, 10000, 0, 0, 0, i)
		removeWorldModel(2823, 10000, 0, 0, 0, i)
		removeWorldModel(2855, 10000, 0, 0, 0, i)
		removeWorldModel(2867, 10000, 0, 0, 0, i)
		removeWorldModel(15038, 10000, 0, 0, 0, i)
		removeWorldModel(2819, 10000, 0, 0, 0, i)
		removeWorldModel(2843, 10000, 0, 0, 0, i)
		removeWorldModel(2844, 10000, 0, 0, 0, i)
