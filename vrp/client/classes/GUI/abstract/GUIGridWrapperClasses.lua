...
GUIGridElement = inherit(GUIElement)
...
function GUIGridElement:constructor(posX, posY, width, height, parent) return GUIElement.constructor(self, grid("x", posX), grid("y", posY), grid("d", width), grid("d", height), parent) end
