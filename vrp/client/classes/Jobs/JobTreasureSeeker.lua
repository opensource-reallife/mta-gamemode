...
function JobTreasureSeeker:constructor()
	Job.constructor(self, 1, 714.30, -1703.26, 2.43, 270, "TreasureSeeker.png", {150, 110, 50}, "files/images/Jobs/HeaderFarmer.png", (HelpTextTitles.Jobs.TreasureSeeker):gsub("Job: ", ""), _(HelpTexts.Jobs.TreasureSeeker), LexiconPages.JobTreasureSeeker, self.onInfo)
