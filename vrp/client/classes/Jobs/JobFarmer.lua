...
function JobFarmer:constructor()
	Job.constructor(self, 158, -62.62, 76.34, 3.12, 250, "Farmer.png", {117, 93, 65}, "files/images/Jobs/HeaderFarmer.png", (HelpTextTitles.Jobs.Farmer):gsub("Job: ", ""), _(HelpTexts.Jobs.Farmer), LexiconPages.JobFarmer, self.onInfo)
	...
	self.m_Blip2:setDisplayText((HelpTextTitles.Jobs.Farmer):gsub("Job: ", ""), BLIP_CATEGORY.Job)
