...
function JobForkLift:constructor()
	Job.constructor(self, 16, 91.70, -221.12, 1.6, 0, "ForkLift.png", {190, 160, 4}, "files/images/Jobs/HeaderForkLift.png", (HelpTextTitles.Jobs.ForkLift):gsub("Job: ", ""), _(HelpTexts.Jobs.ForkLift), LexiconPages.JobForkLift)
