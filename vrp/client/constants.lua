...
HelpTexts = {
	Jobs = {
		...
		ServiceTechnician = "Als Service-Techniker bist du unterwegs zu Kundenstandorten, um technische Probleme zu lösen.\nDu wirst mit Fragen zu verschiedenen IT-Bereichen konfrontiert – von Hardware bis Software.\nDeine Aufgabe ist es, die richtigen Lösungen zu finden, um den Kunden zu helfen.\n\nBeachte: Falsche Antworten bedeuten kein verdientes Geld!";
...
SHADERS = {
	...
	["WaterShine"] = {["event"] = "switchWaterShine" },
...
JobBoxerFights = { --Gewicht, Leben, erforderliches Boxerlevel
	{"Fliegengewicht", 100, 0},
	{"Leichtgewicht", 150, 10},
	{"Mittelgewicht", 200, 25},
	{"Cruisergewicht", 250, 50},
	{"Schwergewicht", 300, 100}
}
