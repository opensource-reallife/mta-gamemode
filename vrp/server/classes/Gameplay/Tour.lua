...
Tour.Data = {
	...
	{
		["Title"] = "Stadthalle / Usertreff",
		["Description"] = "Sobald du den Personalausweis gekauft hast, kannst du die Stadthalle wieder über den weißen Marker verlassen.",
		["Success"] = "Dies ist der Usertreff, auch bekannt als ein beliebter Treffpunkt unter der Community. Ein Vorteil ist, dass der Ort nie schläft und somit stets Spaß und Action bietet!",
		["Position"] = Vector3(1479.62, -1679.51, 13.2),
		["Money"] = 50
	},
	{
		["Title"] = "Fahrschule",
	...
	},
	{
		...
		["Description"] = "Sobald du deinen Führerschein gemacht hast, solltest du dich um einen Fahrbahren Untersatz kümmern. Folge dem Pfeil zum Billig-Autohändler! Du kannst dir am Eingang ein Fahrzeug für den Weg ausleihen.",
