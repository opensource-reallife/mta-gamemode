...
PlayerAttachObjects = {
	[1550] = {model = 1550, name = "Geldsack", pos = Vector3(0, -0.2, 0), rot = Vector3(0, 0, 180), bone = 3, placeDown = true, blockFlyingVehicles = true, pickupAnimantion = {"bomber", "bom_plant", 1000, false, true, true, false}, dropAnimation = {}, loadOnVehicleAnimation = {"ped", "IDLE_chat", 1000, false, true, true, false }, unloadOnVehicleAnimation = {"bomber", "bom_plant", 1000, false, true, true, false}},
	[2912] = {model = 2912, name = "Waffenkiste", pos = Vector3(0, 0.5, 0.35), rot = Vector3(10, 0, 0), blockJump = true, blockSprint = true, blockWeapons = true, blockVehicle = true, animationData = {"carry", "crry_prtial", 1, true, true, false, true}, placeDown = true, pickupAnimantion = {"bomber", "bom_plant", 1000, false, true, true, false}, dropAnimation = {}, loadOnVehicleAnimation = {"ped", "IDLE_chat", 1000, false, true, true, false }, unloadOnVehicleAnimation = {"bomber", "bom_plant", 1000, false, true, true, false}},
	[2919] = {model = 2919, name = "Waffen", pos = Vector3(0, -0.2, 0), rot = Vector3(0, 90, 90), 	blockJump = true, bone = 3, blockSprint = true,  blockVehicle = false, placeDown = true, pickupAnimantion = {"bomber", "bom_plant", 1000, false, true, true, false}, dropAnimation = {}, loadOnVehicleAnimation = {"ped", "IDLE_chat", 1000, false, true, true, false }, unloadOnVehicleAnimation = {"bomber", "bom_plant", 1000, false, true, true, false}},
	[1826] = {model = 1826, name = "Angelruten", pos = Vector3(-0.03, 0.02, 0.05), rot = Vector3(180, 120, 0), blockJump = false, bone = 12, blockSprint = true, blockVehicle = true, pickupAnimantion = {"bomber", "bom_plant", 1000, false, true, true, false}, dropAnimation = {}, loadOnVehicleAnimation = {"ped", "IDLE_chat", 1000, false, true, true, false }, unloadOnVehicleAnimation = {"bomber", "bom_plant", 1000, false, true, true, false}},
	[1575] = {model = 1575, name = "Drogen", pos = Vector3(0, -0.25, 0.12), rot = Vector3(180, 90, 90), bone = 3, blockJump = false, blockSprint = true, blockFlyingVehicles = true, placeDown = true, scale = {x = 1, y = 1.5, z = 1.4}, pickupAnimantion = {"bomber", "bom_plant", 1000, false, true, true, false}, dropAnimation = {}, loadOnVehicleAnimation = {"ped", "IDLE_chat", 1000, false, true, true, false }, unloadOnVehicleAnimation = {"bomber", "bom_plant", 1000, false, true, true, false}},
