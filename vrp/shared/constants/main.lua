...
EVENT_HALLOWEEN = getRealTime().yearday >= EVENT_HALLOWEEN_START_DAY - (DEBUG and 3 or 0) and getRealTime().yearday <= EVENT_HALLOWEEN_START_DAY + 14
...
MARKET_POSSIBLE = not EVENT_CHRISTMAS and not EVENT_EASTER

-- PAYDAY:
PAYDAY_NOOB_BONUS = 250 -- dollar
...
JOB_LEVEL_PIZZA = 0
JOB_LEVEL_SWEEPER = 1
JOB_LEVEL_LOGISTICAN = 5
JOB_LEVEL_TRASHMAN = 1
JOB_LEVEL_TREASURESEEKER = 10
JOB_LEVEL_FORKLIFT = 3
JOB_LEVEL_LUMBERJACK = 7
JOB_LEVEL_HELITRANSPORT = 6
JOB_LEVEL_FARMER = 8
JOB_LEVEL_GRAVEL = 9
JOB_LEVEL_SERVICETECHNICIAN = 2
JOB_LEVEL_BOXER = 4
...
SkinInfo = {
	...
	[24] = {"Los Santos Jacke", 8250, 7},
	[25] = {"College-Jacke", 7500, 7},
	[41] = {"Trainingsanzug", 5000, 7},
	[51] = {"Radfahrer", 8250, 7},
	[52] = {"Radfahrer 2", 8250, 7},
	[63] = {"Latexstrümpfe", 9250, 7},
	[66] = {"College-Jacke 2", 7500, 7},
	[85] = {"Streetworkerin", 6750, 7},
	[90] = {"Crop Top", 9250, 7},
	[95] = {"Armer Rentner", 6750, 7},
	[96] = {"Basketball-Outfit", 6750, 7},
	[99] = {"Radfahrer 3", 8250, 7},
	[138] = {"Weißer Bikini", 9250, 7},
	[139] = {"Gelber Bikini", 9250, 7},
	[140] = {"Roter Bikini", 9250, 7},
	[154] = {"Blaue Badehose", 7500, 7},
	[168] = {"Frittenbude", 6750, 7},
	[187] = {"Business-Anzug, blau gestreift", 10000, 7},
	[189] = {"Kellner", 9250, 7},
	[219] = {"Sekretärin", 10000, 7},
	[234] = {"Rentner mit Sonnenbrille", 7500, 7},
	[236] = {"Rentner mit Schnurrbart", 8250, 7},
	[238] = {"Augenbrauen, rotes Outfit", 8250, 7},

	[16] = {"Lufttransportmitarbeiter", 18000, 9},
	[67] = {"Gangster mit weißem Oberteil", 12000, 9},
	[68] = {"Pfarrer", 16000, 9},
	[92] = {"Skaterin", 15000, 9},
	[151] = {"Jeansrock, schwarze Brille", 12000, 9},
	[152] = {"Zöpfe, rot karierter Rock", 10000, 9},
	[209] = {"Donutladen", 18000, 9},
	[228] = {"Business-Anzug, schwarz", 20000, 9},
	[233] = {"Weißes Shirt, Jeans", 14000, 9},
	[241] = {"Afro mit Bierbauch", 12000, 9},
	[245] = {"Weißes Top, roter Rock", 10000, 9},
	[246] = {"Domina 2", 14000, 9},
	[249] = {"Zuhälter", 17000, 9},
	[251] = {"Beachwatch", 16000, 9},
	[256] = {"4 Zöpfe", 12000, 9},
	[307] = {"Blau-weiß gestreiftes Hemd 2", 15000, 9},

	[80] = {"Boxer, rotes Outfit", 35000, 10},
	[81] = {"Boxer, blaues Outfit", 35000, 10},
	[82] = {"Elvis-Kostüm, grau", 25000, 10},
	[83] = {"Elvis-Kostüm, weiß", 25000, 10},
	[84] = {"Elvis-Kostüm, blau", 25000, 10},
	[156] = {"Jeve Stobs", 25000, 10},
	[162] = {"Alabamaboy", 20000, 10},
	[167] = {"Taste The Cock", 50000, 10},
	[205] = {"Kill Your Hunger", 50000, 10},
	[264] = {"Fetter Clown", 50000, 10},
	[303] = {"Geschäftsmann", 50000, 10},
	[306] = {"Elektronikexperte", 25000, 10},
	[308] = {"Russischer Waffenhändler", 35000, 10},
...
GARAGE_UPGRADES_COSTS = {[1] = 50000, [2] = 100000, [3] = 200000} 
...
HOUSE_INTERIOR_TABLE = {
	...
	[14] = {6, -68.69, 1351.97, 1080.01},
	[15] = {15, 295.10, 1472.88, 1080.06},
	[16] = {8, -42.58, 1405.95, 1084.23},
	[17] = {15, 386.39, 1471.74, 1079.99},
	[18] = {2, 491.18, 1399.36, 1080.06},
	[19] = {10, 24.00, 1340.94, 1084.18},
	[20] = {5, 318.55, 1115.48, 1083.5},
	[21] = {12, 2324.46, -1149.03, 1050.51},
	[22] = {15, 376.24, 1417.29, 1081.13},
	[23] = {2, 447.00, 1398.00, 1084.1},
}
