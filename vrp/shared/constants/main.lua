...
PlayerAttachObjects = {
	...
	[2358] = {model = 2358, name = "Waffen", pos = Vector3(0, 0.45, 0.62), rot = Vector3(10, 0, 0), blockSprint = true, blockFlyingVehicles = true, placeDown = true, blockWeapons = true, animationData = {"carry", "crry_prtial", 1, true, true, false, true}}
}
